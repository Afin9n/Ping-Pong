let canvas, ctx, mousePositionY, botPositionY, time, positionBallX, positionBallY;
let id = 'easeBot';
let score = 0;
let scoreEnemy = 0;
let speedX = 10;
let speedY = Math.ceil(-10 + Math.random() * 20);
let radius = 15;
...
class Rectangle {
    rec() {
        if (mousePositionY > canvas.height - 50)
            mousePositionY = canvas.height - 50;
        if (mousePositionY < 50)
            mousePositionY = 50;
        if (botPositionY > canvas.height - 50)
            botPositionY = canvas.height - 50;
        if (botPositionY < 50)
            botPositionY = 50;
...
class Bots {
    botEase() {
        if (positionBallY > botPositionY - 50)
            botPositionY += 5;
        if (positionBallY < botPositionY - 50)
            botPositionY -= 5;
    }
